...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// button4
			// 
			this->button4->Location = System::Drawing::Point(585, 439);
			...
			// button3
			// 
			this->button3->Location = System::Drawing::Point(389, 439);
			...
			// button2
			// 
			this->button2->Location = System::Drawing::Point(180, 439);
			...
			this->groupBox1->Location = System::Drawing::Point(239, 31);
