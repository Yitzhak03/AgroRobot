...
#pragma endregion
	...
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		Animal^ nuevoAnimal = gcnew Animal(id, especie, peso, edad, estadoSalud, ultimaDieta, gcnew List<Muestra^>(), gcnew Dieta(), gcnew List<HistoriaClinica^>(), ultimaVezAlimentado);
